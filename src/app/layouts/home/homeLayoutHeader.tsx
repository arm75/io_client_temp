...
export default function HomeLayoutHeader(props:any) {
    ...
    return(            
        <>
        {/* <header className="absolute bottom-0 -mx-8 mt-8 w-full h-[200px]"> */}
            <div className="flex flex-row-reverse bg-slate-400 border-b border-gray-200 py-5 px-4">                    
                    ...
                    <nav className="py-1 pt-2 text-sm">
                        <a className="mx-1 py-1 px-3 text-slate-600 font-light hover:py-1 hover:px-3 hover:rounded-full hover:bg-violet-700 hover:text-white">First Link</a>
                        <a className="mx-1 py-1 px-3 text-slate-600 font-light hover:py-1 hover:px-3 hover:rounded-full hover:bg-violet-700 hover:text-white">Second Link</a>
                        <a href="" onClick={logout} className="mx-1 py-1 px-3 text-slate-600 font-light hover:py-1 hover:px-3 hover:rounded-full hover:bg-violet-700 hover:text-white">Logout</a>
                    </nav>
                    ...
                    <span className="mx-1 inline-flex items-center justify-center w-10 h-10 bg-slate-100 relative hover:bg-violet-700 rounded-full">
                        ...
                        {/* <!-- Green Badge Icon --> */}
                        <div
                            className="absolute inline-flex items-center justify-center w-3 h-3 text-xs font-bold text-white bg-emerald-500 border-2 border-white rounded-full -top-0.5 -right-0.5 dark:border-white"
                        ></div>
                        {/* <!-- Yellow Badge Icon --> */}
